...
public class C04_charAt {
    public static void main(String[] args) {
        ...
        System.out.println(str.charAt(14)); // 14 yazarsak hata veriyor. sadece en fazla 13 yazabiliriz.
        // cümlenin kac harf olduğunu bulmak istiyorsak lenght-1 yapmak zorundayız.
    }
}
